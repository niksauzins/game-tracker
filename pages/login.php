...
<main class="md:flex-1 flex justify-center items-center p-6 pt-20">
    <div class="max-w-md w-full custom-card !p-8">
        ...
        <p class="font-mono mt-6 font-bold text-center uppercase text-sm"><?= __('no_account') ?> <a href="register.php" class="text-custom-red hover:underline"> <?= __('register_now') ?></a></p>
    </div>
</main>
