...
<main class="md:flex-1 flex justify-center items-center p-6 pt-14">
    <div class="max-w-md w-full custom-card !p-8">
        ...
        <form action="<?= BASE_URL ?>/actions/register.php" method="POST" class="flex flex-col gap-5">
        ...
        <p class="font-mono mt-6 font-bold text-center uppercase text-sm"><?= __('already_registered') ?> <a href="<?= BASE_URL ?>/pages/login.php" class="text-custom-red hover:underline"> <?= __('login_here') ?></a></p>
    </div>
</main>
